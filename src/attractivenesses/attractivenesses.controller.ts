...
export class AttractivenessesController {
  constructor(private readonly attractivenessesService: AttractivenessesService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateAttractivenessDto: UpdateAttractivenessDto) {
