...
-- CreateEnum
CREATE TYPE "Product" AS ENUM ('AVOCADO', 'WATERMELON', 'PECAN', 'PEAR', 'PINEAPPLE', 'PERSIMMON', 'PEACH', 'ARTICHOKE', 'GRAPEFRUIT', 'BASIL', 'SWEET_POTATO', 'BANANAS', 'GREEN_ONIONS', 'ONION', 'BROCCOLI', 'GIVAY', 'CARROT', 'CHERRY', 'SQUASH', 'PUMPKIN', 'QUINCE', 'ACID', 'LETTUCE', 'EGGPLANT', 'CORIANDER', 'CABBAGE', 'CAULIFLOWER', 'LOVIA', 'ARUM', 'LEMON', 'LIZZY', 'TURNIP', 'HOTEL', 'CUCUMBER', 'MANGO', 'USED', 'MANDARIN', 'NECTARINE', 'BEET', 'CELERY', 'TOMATO', 'CHERRY_TOMATO', 'BEET_LEAVES', 'GRAPE', 'POMELA', 'POMLIT', 'PARSLEY', 'MUSHROOMS', 'HOT_PEPPER', 'PEPPER', 'PASSIONFLOWER', 'PAPAYA', 'SABRA', 'RADISH', 'RADISHES', 'COLORBY', 'KIWI', 'ZUCCHINI', 'CLEMENTINE', 'CARAMBOLA', 'POMEGRANATE', 'GARLIC', 'GUARD', 'PLUM', 'LOQUAT', 'DILL', 'BEAN', 'STRAWBERRIES', 'CORN', 'TAMAR', 'POTATO', 'APPLE', 'ORANGE');
